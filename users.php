...
// подтягиваем из базы остальные данные авторизованного пользователя
$_SESSION["current_user"] = get_user_data($connection, $_SESSION['current_user']['id']);

// получаем данные всех пользователей для отображения на странице
                        ...
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                ...
                                <div class="info-card-text flex-1">
                                    ...
                                    <!-- Имя пользователя со ссылкой на page_profile.php -->
                                    <?php echo $user['name'];?>

                                    <!-- Опции только для админа или для себя -->
                                    <?php if ($allow_to_see_options):?>
