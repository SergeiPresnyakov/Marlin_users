...
// если попал на страницу без id в заголовке url
if (!isset($_GET['id'])) {
    redirect_to("/tasks3/users.php");
}

// если не админ и пытаешься редактировать не свой профиль
if ($_SESSION['current_user']['role'] != "admin" && !is_author($_SESSION['current_user']['id'], $_GET['id'])) {
...
$user = get_user_by_id($connection, $_GET['id']);
...
<body>
    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        // наш текущий статус
        $current_status = $class_to_status[$user['status']];
        ?>

        <form action="change_status.php?id=<?php echo $_GET['id']?>" method="POST">
            <div class="row">
                <div class="col-xl-6">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="example-select" name="status">
                                                <?php foreach ($class_to_status as $class => $status):?>
                                                    <option <?php echo $current_status == $status ? "selected" : "";?>><?php echo $status;?></option>    
                                                <?php endforeach;?>
                                            </select>
                                        </div>
